...
<body>
    ...
    <section class="section-container" id="category">
        <div class="container">
            <div class="section-head-container">
                <h6>OUR TOP CATEGORIES</h6>
                <h2>Categories</h2>
            ...
            <div class="category-list">
                <div class="category-card" id="">
                    <img src="https://marketplace.foodotawp.com/wp-content/uploads/2021/05/Layer256-1.png" height="220" width="250" alt="Category Image" />
                ...
                <div class="category-card" id="">
                    <img src="https://marketplace.foodotawp.com/wp-content/uploads/2021/05/1qLayer-1.png" height="220" width="250" alt="Category Image" />
                    <div class="category-card-text">
                        <h6>Category Name</h6>
                        <p>description</p>
                    </div>
                ...
                <div class="category-card" id="">
                    <img src="https://marketplace.foodotawp.com/wp-content/uploads/2021/05/sa1.png" height="220" width="250" alt="Category Image" />
                    <div class="category-card-text">
                        <h6>Category Name</h6>
                        <p>description</p>
                    </div>
                ...
                <div class="category-card" id="">
                    <img src="https://marketplace.foodotawp.com/wp-content/uploads/2021/05/pngwing.png" height="220" width="250" alt="Category Image" />
                    <div class="category-card-text">
                        <h6>Category Name</h6>
                        <p>description</p>
                    </div>
    ...
    <section class="" id="how">
        <div class="how-list">
            <div class="how-card" id="">
                <i class="fa-solid fa-list how-icon"></i>
                <h6>View Food Item</h6>
            ...
            <div class="how-card" id="">
                <i class="fa-solid fa-credit-card how-icon"></i>
                <h6>Place Order</h6>
            ...
            <div class="how-card" id="">
                <i class="fa-solid fa-truck how-icon"></i>
                <h6>Deliver to Doorstep</h6>
        ...
        <div class="container" id="">
            <div class="section-head-container" id="how-header">
